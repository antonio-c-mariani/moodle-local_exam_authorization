...
$capabilities = array(
    ...
    'local/exam_authorization:write_exam' => array(
        'captype' => 'read',
    ...
    'local/exam_authorization:take_exam' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
            'student' => CAP_ALLOW
    ...
    'local/exam_authorization:supervise_exam' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_COURSE,
    ),

    'local/exam_authorization:monitor_exam' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_COURSE,
    ),
